...
const homeBottomCreative = '<a class="bottom-creative" href="article.html?slug=arena-breakout-infinite-pc-guide" aria-label="Explore Arena Breakout: Infinite coverage"><img class="bottom-creative-home-image" src="affiliate-assets/arena-breakout-footer-994x102.png" alt="Arena Breakout: Infinite tactical extraction shooter promotion"></a><button type="button" aria-label="Close ad">×</button>';
